...
<div class="row">
    <div class="large-12 columns">
        <h2>Kitchen Sink</h2>
        <h4 class="subheader">This page included every single Foundation element so that we can make sure things work
            together smoothly.</h4>
        <hr>
    </div>
</div>
...
<div>
    <ul class="clearing-thumbs" data-clearing>
        <li><a class="th" href="{$ThemeDir}/images/demos/demo1.jpg"><img
                data-caption="Nulla vitae elit libero, a pharetra augue. Cras mattis consectetur purus sit amet fermentum."
                src="{$ThemeDir}/images/demos/demo1-th.jpg"></a></li>
        <li><a class="th" href="{$ThemeDir}/images/demos/demo2.jpg"><img
                src="{$ThemeDir}/images/demos/demo2-th.jpg"></a></li>
        <li><a class="th" href="{$ThemeDir}/images/demos/demo3.jpg"><img
                ...
                src="{$ThemeDir}/images/demos/demo3-th.jpg"></a></li>
        <li><a class="th" href="{$ThemeDir}/images/demos/demo4.jpg"><img
                src="{$ThemeDir}/images/demos/demo4-th.jpg"></a></li>
        <li><a class="th" href="{$ThemeDir}/images/demos/demo5.jpg"><img
                data-caption="Integer posuere erat a ante venenatis dapibus posuere velit aliquet."
                src="{$ThemeDir}/images/demos/demo5-th.jpg"></a></li>
    </ul>
</div>
...
<form class="custom">
    <div class="row">
        <div class="large-4 columns">
            <label for="radio1"><input name="radio1" type="radio" id="radio1" style="display:none;" CHECKED><span
                    class="custom radio checked"></span> Radio Button 1</label>
            <label for="radio1"><input name="radio1" type="radio" id="radio1" style="display:none;"><span
                    class="custom radio"></span> Radio Button 2</label>
            <label for="radio1"><input name="radio1" type="radio" id="radio1" disabled style="display:none;"><span
        ...
        <div class="large-4 columns">
            ...
            <label for="checkbox3"><input type="checkbox" CHECKED id="checkbox3" style="display: none;"><span
                    class="custom checkbox checked"></span> Label for Checkbox</label>
        </div>
        <div class="large-4 columns">
    ...
    <div class="large-9 columns">
        ...
        <div class="section-container auto" data-section data-options="deep_linking: true;">
            <section class="section">
                ...
                <div class="content" data-slug="panel1">
                    <p>Section 1. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
            ...
            <section class="section">
                ...
                <div class="content" data-slug="panel2">
                    <p>Section 2. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                        incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
                        ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
            </section>
        ...
        <div class="section-container accordion" data-section="accordion">
            ...
            <section class="section">
                ...
                <div class="content" data-slug="panel3">
                    <p>Section 3. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
                        incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
                        ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
            </section>
...
<p>The tooltips can be positioned on the <span data-tooltip class="has-tip" data-width="210"
    ...
    which is the default position, <span data-tooltip class="has-tip tip-top noradius" data-width="210"
            ...
            data-tooltip="left" class="has-tip tip-left" data-width="90" title="I'm on the left!">"tip-left"</span>, or
...
<div id="contentDrop" class="f-dropdown content medium" data-dropdown-content>
    ...
    <p>Some text that people will think is awesome! Some text that people will think is awesome! Some text that people
        will think is awesome!</p>
    <img src="{$ThemeDir}/images/demos/demo1.jpg">
...
<div id="videoModal" class="reveal-modal large">
    ...
    <div class="flex-video">
        <iframe width="800" height="315" src="http://www.youtube.com/embed/IkOQw96cfyE" frameborder="0"
                allowfullscreen></iframe>
    </div>
    <a class="close-reveal-modal">&#215;</a>
</div>